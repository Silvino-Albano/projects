  ...
  <div class="page">
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <h1 class="hero-title">Temukan Kos<br><em>Impian Anda</em></h1>
        <p class="hero-sub">Ratusan pilihan kos terbaik di seluruh penjuru Dili — nyaman, terjangkau, dan strategis.</p>
...
export default {
 ...
 // ✅ Tambah ini di sini
  const userRole = computed(() => {
    ...
    // Kumpulkan nama zona unik untuk filter
    const uniqueZonas = computed(() => {
      const set = new Set(
        kosStore.kosList
          .map(k => k.zona?.nama_zona)
          .filter(Boolean)
      )
     return { 
    kosStore, 
    isLoggedIn, 
    userRole,        // ✅ tambah di return
    selectedZona, 
    uniqueZonas, 
    filteredKos, 
    handleLogout 
    ...
    // Filter berdasarkan zona yang dipilih
    ...
    return { kosStore, isLoggedIn, selectedZona, uniqueZonas, filteredKos, handleLogout }
  }
}
